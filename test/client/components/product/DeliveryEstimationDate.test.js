...
describe('DeliveryEstimationDate Class', () => {
    let Component;
    let component;
    let element;
    let sandbox;
    ...
    before((done) => {
        ...
        template = getTemplate(null, 'components/product/deliveryestimationdate.hbs', {
            // Model needed for the HBS template
        });

        importModule('components/product/DeliveryEstimationDate.js').then((module) => {
    ...
    beforeEach(() => {
        ...
        element = document.querySelector('[data-component="product/DeliveryEstimationDate"]');
