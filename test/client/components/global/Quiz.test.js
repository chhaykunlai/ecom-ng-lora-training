...
describe('Quiz Class', () => {
    ...
    before((done) => {
        ...
        template = getTemplate(null, 'components/global/quiz.hbs', {
            // Model needed for the HBS template
        });

        importModule('components/global/Quiz.js').then((module) => {
    ...
    beforeEach(() => {
        ...
        element = document.querySelector('[data-component="global/Quiz"]');
