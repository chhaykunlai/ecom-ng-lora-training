...
describe('ImpactRadius Class', () => {
    ...
    before((done) => {
        ...
        template = getTemplate(null, 'components/global/impactradius.hbs', {
            // Model needed for the HBS template
        });

        importModule('components/global/ImpactRadius.js').then((module) => {
    ...
    beforeEach(() => {
        ...
        element = document.querySelector('[data-component="global/ImpactRadius"]');
